...
if __name__ == '__main__':
    ...
    list_reducida = [int(x) if x.isdigit() else 0 for x in list_numeros_str]
    print(list_reducida)
    ...
    list_numeros_str_neg = ['5', '2', '3', '', '-7', 'NaN']
    list_reducida_neg = [int(x) if x.isdigit() else 0 for x in list_numeros_str_neg]
    print(list_numeros_str_neg)
    print("terminamos")